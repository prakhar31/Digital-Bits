                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Your personal information</h3>
                                <p></p>
                                <form role="form">
                                    <div class="form-group"><label>Full Name</label> <input value="<?php { echo $pass_row['name'];}?>"type="email" class="form-control" disabled="disabled"></div>
                                    <div class="form-group"><label>Contact Number</label> <input value="<?php { echo $pass_row['s_mobile'];}?>"type="number" class="form-control" disabled="disabled"></div>
                                   <div class="form-group"><label>Hostel</label> <input value="<?php { echo $pass_row['Hostel'];}?>" type="text" class="form-control" disabled="disabled"></div>
                                </form>
                            </div>
                            <div class="col-sm-6"> <form role="form">
                                    <div class="form-group"><label> Room Number</label> <input value="<?php { echo $pass_row['room_no'];}?>"type="text" class="form-control" disabled="disabled"></div><br>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal">
                                <p></p>
                                <div class="form-group"><label class="col-lg-2 control-label">Fathers Name</label>

                                    <div class="col-lg-10"><input value="<?php { echo $pass_row['f_name'];}?>" type="text" class="form-control" disabled="disabled"> <span class="help-block m-b-none"></span>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Contact Number</label>

                                    <div class="col-lg-10"><input value="<?php { echo $pass_row['f_mobile'];}?>" type="telephone"  class="form-control" disabled="disabled"></div>
									
                                </div>
								<div class="form-group"><label class="col-lg-2 control-label">Email ID</label>

                                    <div class="col-lg-10"><input value="<?php { echo $pass_row['f_email'];}?>" type="email"  class="form-control" disabled="disabled"></div>
									
                                </div>
								<div class="form-group"><label class="col-lg-2 control-label">Mothers Name</label>

                                    <div class="col-lg-10"><input  value="<?php { echo $pass_row['m_name'];}?>"type="text" class="form-control" disabled="disabled"></div>
									
                                </div>
								<div class="form-group"><label class="col-lg-2 control-label">Contact Number</label>

                                    <div class="col-lg-10"><input  value="<?php { echo $pass_row['m_mobile'];}?>"type="telephone" class="form-control" disabled="disabled"></div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Email ID</label>

                                <div class="col-lg-10"><input value="<?php { echo $pass_row['m_email'];}?>" type="email"  class="form-control" disabled="disabled"></div>
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <?php 
        echo form_open('outstation/enter_details');?>
                            <h5>Outstation Form <small></small></h5>
                            <div class="ibox-tools">
                                <a class="collapse-link">
                                    <i class="fa fa-chevron-up"></i>
                                </a>
                        ...
                        <div class="ibox-content">
                            <form method="get" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">Enter Your Destination</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" id="destination" name="destination"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Enter Your Exit Time</label>
                            <div class="input-group clockpicker" data-autoclose="true">
                                <input type="text" class="form-control" value="09:30"  name="exittime">
                                ...
                                <label class="col-sm-2 control-label">Select Exit - Entry Date</label>
                                <div class="input-daterange input-group" id="datepicker">
                                    <input type="text" class="input-sm form-control" name="exitdate" placeholder="Exit Date"/>
                                    <span class="input-group-addon">to</span>
                                    <input type="text" class="input-sm form-control" name="returndate" placeholder="Entry Date" />
                                </div>
                            </div>
							<div class="hr-line-dashed"></div>
                               <div class="form-group"><label class="col-sm-2 control-label">Enter Entry Time</label>
                            <div class="input-group clockpicker" data-autoclose="true">
                                <input type="text" class="form-control" value="09:30" name="returntime">
                                <span class="input-group-addon">
                                    <span class="fa fa-clock-o"></span>
                                </span>
                            </div>
