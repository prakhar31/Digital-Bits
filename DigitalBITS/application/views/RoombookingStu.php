            ...
            <div class="col-lg-7">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Room Booking Form <small></small></h5>
                            <div class="ibox-tools">
                                <a class="collapse-link">
                                    <i class="fa fa-chevron-up"></i>
                                </a>
                        ...
                        <div class="ibox-content">
                            <form method="get" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">Name of Organisation</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" id="destination" placeholder="Club/Dept/Association"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
							    <div class="form-group"><label class="col-sm-2 control-label">Enter Room Number</label>

                                    <div class="col-sm-10"><input type="number" class="form-control" id="destination" placeholder="Roon you want to book"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group" id="data_5">
                                <label class="col-sm-2 control-label">Select Date on which you want to book</label>
                                <div class="input-daterange input-group" id="datepicker" style="padding-left:1.6%">
                                    <input type="text" class="input-sm form-control" name="start" placeholder="Date you want the room"/>
                            ...
                            <div class="input-group clockpicker" data-autoclose="true">
								...
								<div class="form-group"><label class="col-sm-2 control-label">Reason You want the room</label>
                                    <div class="col-sm-10" style="margin-left:-15px;"><input type="text" class="form-control" id="reason" placeholder="Why you want the room"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
