		...
		<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Mess Signing Form</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="col-lg-7">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Your personal information</h3>
                                <p></p>
                                <form role="form">
                                    <div class="form-group"><label>Full Name</label> <input type="email" class="form-control" disabled="disabled"></div>
                                    <div class="form-group"><label>Contact Number</label> <input type="number" class="form-control" disabled="disabled"></div>
                                   <div class="form-group"><label>Hostel</label> <input type="text" class="form-control" disabled="disabled"></div>
                                </form>
                            </div>
                            <div class="col-sm-6"> <form role="form">
                                    <div class="form-group"><label>Enter Room Number</label> <input type="text" class="form-control" disabled="disabled"></div><br>
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">Fathers Name</label>
                                    ...
                                    <div class="col-lg-10"><input type="text" class="form-control" disabled="disabled"> <span class="help-block m-b-none"></span>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Contact Number</label>

                                    <div class="col-lg-10"><input type="telephone"  class="form-control" disabled="disabled"></div>
									
                                </div>
								<div class="form-group"><label class="col-lg-2 control-label">Email ID</label>

                                    <div class="col-lg-10"><input type="email"  class="form-control" disabled="disabled"></div>
									
                                </div>
								<div class="form-group"><label class="col-lg-2 control-label">Mothers Name</label>

                                    <div class="col-lg-10"><input type="text" class="form-control" disabled="disabled"></div>
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Mess Signing Form <small></small></h5>
                            <div class="ibox-tools">
                                <a class="collapse-link">
                                    <i class="fa fa-chevron-up"></i>
                                </a>
                        ...
                        <div class="ibox-content">
                            <form method="get" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">Enter Organization Name</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" id="destination" placeholder="Club/Dept/Association"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Enter Your Time Range</label>
                            <div class="input-group clockpicker" data-autoclose="true">
                                ...
                                <div class="input-daterange input-group" id="datepicker">
                                    <input type="text" class="input-sm form-control" name="start" placeholder="Exit Date"/>
                           ...
                           <form id="my-awesome-dropzone" class="dropzone" action="#">
                            <iframe src="<?php echo base_url(); ?>assets/form_file_upload.html" height="533px" width="80%">
                            </iframe>
                        </form>
