    ...
    <div id= "page-wrapper" class="gray-bg">
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			 ...
			 <div class= "wrapper wrapper-content animated fadeInRight">
                <?php 
    echo form_open('Rootmail/req_pass1');
    foreach($Rootmaildata as $mediator){?>
            
             <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Root Mail Form by <label id="username"><?php  echo $mediator['bitsid'];?></label> <small></small></h5>
...
<div style="padding-left:13%;">
                                    <div class="col-sm-10"><input type="text" class="form-control disabled-result" value ="<?php  echo $mediator['name'];?>" id="name" disabled="disabled"></div>
                                </div>
                               </div> 
								...
								<div class="form-group"><label class="col-sm-2 control-label">Name Of Organization</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" value ="<?php  echo $mediator['from'];?>" class="form-control" id="destination" disabled="disabled"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                      ...
                      <div class="col-sm-10"><input type="text" class="form-control" id="destination" disabled="disabled"></div>
                                ...
                                <label class="col-sm-2 control-label">Body of Mail</label>
                                <div class="col-sm-10"><textarea class="form-control" value ="<?php  echo $mediator['data'];?>" rows="17" disabled="disabled"></textarea></div>
                            </div>
							<div class="hr-line-dashed"></div>
                               <div class="form-group">
                            <label class="col-sm-2 control-label">Date for sending the mail</label>
                                <div class="input-daterange input-group" id="datepicker" style="padding-left:1.5%;">
                                    <input type="text"  class="input-sm form-control" name="start" placeholder="<?php  echo $mediator['date'];?>" disabled="disabled"/>
                                    
                                </div>
                                </div>
                                <div class="hr-line-dashed"></div>
								<div class="form-group">
                           <label class="col-sm-2 control-label">Bits mail of faculty advisor</label>
                             <div class="col-sm-10"><input type="text"  value ="<?php  echo $mediator['Prof'];?>"class="form-control" id="to" placeholder="Students/Faculty" disabled="disabled"></div>
                                </div>
								<div class="hr-line-dashed"></div>
...
<br>
                                    <div class="col-sm-10"><input type="password"  name="req_pass" class="form-control" id="passcode"><br></div>
