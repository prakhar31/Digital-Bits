...
<body>
	...
	<div id= "page-wrapper" class="gray-bg">
        ...
        <div class="row">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                               ...
                               <a href="outstation.html" style="color:#000000;"> <h5>Outstation</h5></a>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins" id="used_service">00</h1>
                                <div class="stat-percent font-bold text-success"><i class="fa fa-olt"></i></div>
                                <small></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-info pull-right">Form</span>
                                 <a href="outstation.html" style="color:#000000;"><h5>Mess Signing</h5></a>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins" id="used_service1">00</h1>
                                <div class="stat-percent font-bold text-info"><i class="fa fa-lvel-up"></i></div>
                                <small></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-primary pull-right">Form</span>
                                 <a href="outstation.html" style="color:#000000;"><h5>Room Booking</h5></a>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins" id="used_service2">00</h1>
                                <div class="stat-percent font-bold text-navy"> <i class="fa fa-leve-up"></i></div>
                                <small></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-danger pull-right">Form</span>
                                 <a href="outstation.html" style="color:#000000;"><h5>Root Mail</h5></a>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins" id="used_service3">00</h1>
                                <div class="stat-percent font-bold text-danger"> <i class="fa fa-levl-down"></i></div>
                                <small></small>
                            </div>
                        </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                <div class="col-lg-9">
                                    Here Will be text regarding upcoming mess signing......
                                </div>
                                <div class="col-lg-3">
                                    <ul class="stat-list">
                                        <li>
                                            <h2 class="no-margins">00</h2>
                                ...
                                <div class="feed-activity-list">
                                    ...
                                    <div class="feed-element">
                                        <div>
                                            ...
                                            <strong>Name of Request (room booking etc)</strong>
                                            <div>Short text stating whome given</div>
    ...
    <script src="<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
