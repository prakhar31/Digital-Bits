...
<head>
   <meta charset="utf-8">
    ...
    <title>BITS DIGITAL | Room Booking</title>
		...
		<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Room Booking Form</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Room Booking Form by <label id="username">Name of Student</label> <small></small></h5>
...
<div style="padding-left:13%;">
                                    <div class="col-sm-10"><input type="text" class="form-control disabled-result" id="name" disabled="disabled"></div>
                                </div>
                               </div> 
								<div class="form-group col-sm-4" style="margin-left:-30px;"><label class="col-sm-2 control-label">Room</label>
<div style="padding-left:18%;">
                                    <div class="col-sm-10"><input type="text" class="form-control" id="roomnumber" disabled="disabled"></div>
                                </div>
                               </div>
							   <div class="form-group col-sm-4" style="margin-left:-30px;"><label class="col-sm-5 control-label">Room Booked</label>
<div style="padding-left:18%;">
                                    <div class="col-sm-7"><input type="text" class="form-control" id="roomnumber" disabled="disabled"></div>
                                </div>
                               </div>
								</div></div>
                                <div class="hr-line-dashed"></div>
								<div class="form-group"><label class="col-sm-2 control-label">Name Of Organization</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" id="destination" disabled="disabled"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group" id="data_5">
                                <label class="col-sm-2 control-label">Date on which room is booked</label>
                                <div class="input-daterange input-group" id="datepicker" style="padding-left:1.6%">
                                    <input type="text" class="input-sm form-control" name="start" disabled="disabled">
							...
							<div class="hr-line-dashed"></div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Reason You want the room</label>
                                    <div class="col-sm-10" style="margin-left:-15px;"><input type="text" class="form-control" id="reason" disabled="disabled"></div>
                                </div>
                                
                                <div class="hr-line-dashed"></div>
                               <div class="form-group"><label class="col-sm-2 control-label"><br/><small class="text-navy"></small></label>
                                    <div class="col-sm-10">
                                        <div class="i-checks" class="active"><label> <input type="radio" value="option1" name="a" class="active"> <i></i> Accept </label></div>
                                        <div class="i-checks"><label> <input type="radio" value="option2" name="a"> <i></i> Reject </label></div>
		...
		<br><br><br><br><br><br><br><br>
		 <div class="footer">
		  <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                     <div class="form-group"><label class="col-sm-12 control-label"><br>Enter Passcode</label>
<br>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="passcode"><br></div>
   ...
   <script src="<?php echo base_url(); ?>assets/js/plugins/switchery/switchery.js"></script>
    ...
    <!-- IonRangeSlider -->
    <script src="j<?php echo base_url(); ?>assets/s/plugins/ionRangeSlider/ion.rangeSlider.min.js"></script>
